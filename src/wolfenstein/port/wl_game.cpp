	...
	do
	{
		...
		switch (playstate)
		{
			...
			case ex_died:
				...
				// Blake: defeat screen (LOSEPIC backdrop + the LOSEART message),
				// mirroring bstone's LoseScreen() at ex_died (3d_game.cpp:3247).
				// Inert for Wolf/Spear.
				Blake_ShowLoseScreen ();
